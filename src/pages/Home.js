...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Analyze complex data sets and build predictive models using cutting-edge tools.',
    ...
    },
    {
      ...
      title: 'Cybersecurity',
      description:
        'Protect digital assets and learn ethical hacking techniques from industry experts.',
    ...
    },
    {
      ...
      description:
        'Explore artificial intelligence and build intelligent systems for the future.',
      ...
      <section className="hero-section d-flex align-items-center text-center text-white">
        ...
        <div className="container position-relative z-2">
          <h1 className="hero-title">
            PDEA’s College <span className="text-gradient">of Engineering</span>
          </h1>
          <p className="hero-description">
            Join our world-class IT Department where innovation meets education.
            Discover cutting-edge programs designed to prepare you for tomorrow&apos;s
            technology challenges.
          </p>
          <div className="d-flex justify-content-center gap-3 pt-4 flex-wrap">
            <Link
              to="/programs"
              className="btn btn-primary btn-lg d-flex align-items-center gap-2 shadow-sm btn-gradient"
            >
        ...
        <div className="container">
          <div className="text-center mb-5">
            <h2 className="display-5 fw-bold">
              People Placed, Alumni & Companies for Placement
            </h2>
            <p className="text-muted fs-5 mx-auto" style={{ maxWidth: 600 }}>
              Our students have been placed in top companies worldwide, supported by a
          ...
          <div className="row gy-4">
            ...
            <div className="col-12 col-md-4">
              <div className="placement-card p-4 rounded shadow-sm bg-white h-100 d-flex flex-column">
                ...
                <p className="text-muted text-center flex-grow-1">
                  Our alumni are leaders in their fields, offering mentorship and support
                  to current students.
                </p>
                <div className="alumni-list mt-3">
                  <ul>
                    <li>
                      <strong>Rahul Mehta</strong> - Software Engineer at Google
                    </li>
                    <li>
                      <strong>Anjali Rao</strong> - Data Scientist at Amazon
                    </li>
                    <li>
                      <strong>Vikram Singh</strong> - Cybersecurity Expert at Cisco
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section className="py-5 text-center text-white cta-section">
        <div className="container">
          ...
          <p className="mb-4 lead mx-auto" style={{ maxWidth: 600 }}>
            ...
            technology. Your future in IT starts here.
          </p>
          <div className="d-flex justify-content-center gap-3 flex-wrap">
            <Link
              to="/programs"
              className="btn btn-light btn-lg d-flex align-items-center gap-2 shadow-sm btn-cta"
            >
